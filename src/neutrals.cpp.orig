...
void Neutrals::calc_NO_cool(Report &report) { 
  ...
  if(iNO != -1){
    ...
    arma_cube omega = 3.6e-17 * species[iO].density_scgc / (3.6e-17 * species[iO].density_scgc + 13.3); 
...
void Neutrals::calc_O_cool(Report &report) {
  ...
  if(iO != -1){
    ...
    arma_cube O_cool_scgc_calc = (1.69e-18 * tmp2 + 4.59e-20 * tmp3) % (species[iO].density_scgc/1.0e6) / (1.0 + 0.6*tmp2 + 0.2*tmp3);
