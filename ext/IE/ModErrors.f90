...
module ModErrors
  ...
  integer, parameter :: ecAeNotSet_        = 13
  integer, parameter :: ecAlNotSet_        = 14
  integer, parameter :: ecAuNotSet_        = 15
  integer, parameter :: ecEFieldModelNotFound_ = 16
  integer, parameter :: ecAuroralModelNotFound_ = 17
  integer, parameter :: ecSWNNotSet_       = 18
...
contains
  ...
  subroutine set_error_codes
    ...
    cErrorCodes(ecAuNotSet_)       = "Au has not been set"
    cErrorCodes(ecAlNotSet_)       = "Al has not been set"
    cErrorCodes(ecAeNotSet_)       = "Ae has not been set"
