...
cp -R ../../share/run ./run.22_euvac
cd run.22_euvac
cp ../aether.json.22_euvac ./aether.json
mpirun -np 4 ./aether
cd UA/output
...
# run 22 wavelengths, hfg solomon model
cp -R ../../share/run ./run.22_hfg
cd run.22_hfg
cp ../aether.json.22_hfg ./aether.json
mpirun -np 4 ./aether
cd UA/output
../../../../../srcPython/postAether.py -rm
# This assumes aetherpy is installed and the plotter is in the bin directory:
